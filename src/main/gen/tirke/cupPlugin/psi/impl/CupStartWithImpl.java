...
public class CupStartWithImpl extends ASTWrapperPsiElement implements CupStartWith {

  public CupStartWithImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CupVisitor visitor) {
    visitor.visitStartWith(this);
  }
