...
public class CupClassNameDeclarationImpl extends ASTWrapperPsiElement implements CupClassNameDeclaration {

  public CupClassNameDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
