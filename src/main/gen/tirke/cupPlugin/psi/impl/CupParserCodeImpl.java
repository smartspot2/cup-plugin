...
public class CupParserCodeImpl extends ASTWrapperPsiElement implements CupParserCode {

  public CupParserCodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CupVisitor visitor) {
    visitor.visitParserCode(this);
  }
