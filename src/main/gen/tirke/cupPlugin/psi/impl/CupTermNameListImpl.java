...
public class CupTermNameListImpl extends ASTWrapperPsiElement implements CupTermNameList {

  public CupTermNameListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CupVisitor visitor) {
    visitor.visitTermNameList(this);
  }
